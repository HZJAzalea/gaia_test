package com.cn.nvwa_testcase_statistics.util;
...
//                dataSource.setUsername("root");
//                dataSource.setPassword("nvwa_testcase_statistics@passwd");

//				//测试环境数据库
//                dataSource.setUrl("jdbc:mysql://10.100.130.14:3306/nvwa_cloud_auth?useSSL=false");
//                dataSource.setUsername("nvwa_user");
//                dataSource.setPassword("nvwa_testcase_statistics@passwd");

                //测试环境数据库
                dataSource.setUrl("jdbc:mysql://10.100.10.9:3306/control_center?useSSL=false");
                dataSource.setUsername("control_center");
                dataSource.setPassword("JEyMeu281=+");
